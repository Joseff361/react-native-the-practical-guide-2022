...
function ExpenseForm({ submitButtonLabel, onCanel, onSubmit, defaultValues }) {
      ...
      <View style={styles.inputsRow}>
        <Input
          ...
          textInputConfig={{
            ...
            // The value that is returned by onChangeText is ALWAYS an string no matter the keyboardType
        ...
        <Input
          ...
          textInputConfig={{
            ...
            maxLength: 10,
            // the last parameter will be the input value
